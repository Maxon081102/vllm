...
from .jump_layers import JumpLayersConfig
...
class VllmConfig:
    ...
    jump_layers_config: JumpLayersConfig | None = None
    """The configurations for jump layers (layer skipping via trained jump heads)."""
