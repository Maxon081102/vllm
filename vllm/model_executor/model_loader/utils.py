...
def initialize_model(
    ...
    *,
    ...
    # Set current vllm_config BEFORE resolving model architecture
    # This allows resolve_model_cls to check for jump_layers_config
    # and auto-switch to jump layers variant if needed
